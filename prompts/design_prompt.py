...
REMEMBER when you are not confident on arithmetic operation such as complex mathmatical computation, you must use calculator to get the accurate results before entering to the next step. 
